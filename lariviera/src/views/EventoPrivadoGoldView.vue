 ...
 <div
    ...
    <div class="m-5 p-2.5 font-serif text-2xl" style="font-family: 'Comfortaa', sans-serif;">
      ...
      <h2 class="text-justify carta px-4">
        ...
        Es un honor para nosotros ser parte de este momento tan especial en sus vidas. En
        nombre del <b>Salón de Eventos La Riviera</b>, nos especializamos en crear
        celebraciones inolvidables, cuidando cada detalle para que disfruten de una fiesta
        mágica y sin preocupaciones. A continuación, les presentamos nuestra propuesta de
        cotización, diseñada para adaptarse a sus necesidades y hacer realidad la
        celebración de sus sueños. Quedamos atentos a cualquier consulta o ajuste que deseen
          ...
          <tbody>
            <tr>
              ...
              <td class="border px-4 py-2 text-left align-top min-w-[200px]">
                ...
                <p class="text-justify italic">• Papas fritas - mani</p>
              </td>
              <td class="border px-4 py-2 text-left align-top min-w-[200px]">
                <p class="text-justify italic font-bold">Plato Sevido</p>
                <p class="text-justify italic">• Cena un tipo de carne a elección</p>
                <p class="text-justify italic">• Dos guarniciones  a eleccion</p>
                <p class="text-justify italic">• Una ensalada</p>
              </td>
            </tr>
            <!-- Fila 2 -->
            <tr>
              <td class="border px-4 py-2 text-left align-top min-w-[200px]">
                ...
                <p class="text-justify italic">• Amplificación</p>
                <p class="text-justify italic">• Luces LED </p>               

              </td>
              <td class="border px-4 py-2 text-left align-top min-w-[200px]">
                <p class="text-justify italic font-bold">Luminotecnia</p>
                <p class="text-justify italic">• 25 puntos de luces LED</p>
                <p class="text-justify italic">• Instalación y desinstalación de luces</p>
                <p class="text-justify italic">• Controlador digital de luces</p>
              </td>
              <td class="border px-4 py-2 text-left align-top min-w-[200px] personal-atencion">
                <p class="text-justify italic font-bold">Bebidas en mesa con alcohol (1 TRAGO)</p>
                <p class="text-justify italic">• 1 Ron carta vieja</p>
                <p class="text-justify italic">• 1 Singani Casa real negro</p>                
              </td>
            </tr>
            <!-- Fila 3 -->
            <tr>
      ...
      <div class="w-full max-w-2xl mx-auto px-4">
        ...
        <div class="overflow-x-auto">
          <table class="w-full border-collapse mt-4">
            ...
            <tbody>
              <tr class="border-b">
                <td class="px-4 py-2 text-base text-white">Cantidad de personas</td>
                <td class="px-4 py-2 text-base text-black font-bold text-600 recuadro">
              ...
              <tr class="border-b">
                <td class="px-4 py-2 text-sm text-white">Precio Unitario</td>
                <td class="px-4 py-2 text-sm text-white">{{ precioUnitario }} Bs</td>
              </tr>
              <tr>
                <td class="px-4 py-2 text-base text-white">Total</td>
                <td class="px-4 py-2 text-base font-semibold text-white">{{ total }} Bs</td>
              </tr>
            </tbody>
          </table>
        </div>
