        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="border px-4 py-2 text-left align-top">
              ...
              <p class="text-justify italic">• Cena dos tipos de carne a elección	
              </p>
          ...
          <tr>
            ...
            <td class="border px-4 py-2 text-left align-top">
              ...
              <p class="text-justify italic">•  Ron carta vieja / Abuelo
              </p>   
              <p class="text-justify italic">•  Ron carta vieja o/ Fernet	
              </p>
              <p class="text-justify italic">•  Ron Solera	
              </p>    
              <p class="text-justify italic">•  Singani / Casa real negro	
              </p>        
            </td>            
          </tr>
          <!-- Fila 3 -->
