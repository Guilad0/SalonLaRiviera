        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="border px-4 py-2 text-left align-top">
              ...
              <p class="text-justify italic">• Cena tres tipos de carne a elección</p>
              <p class="text-justify italic">• Bufé de ensaladas y guarniciones</p>
          ...
          <tr>
            ...
            <td class="border px-4 py-2 text-left align-top">
              ...
              <p class="text-justify italic">• Ron o/ Fernet</p>
              <p class="text-justify italic">• Singani / casa resal negro</p>
            </td>
          </tr>
          <!-- Fila 3 -->
          <tr>
...
export default {
  ...
  data() {
    return {
      ...
      precioUnitario: 210, // Precio de ejemplo
    };
  },
  computed: {
    paqueteId() {
