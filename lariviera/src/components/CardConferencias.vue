...
const events = ref([
  ...
  {
    title: "Conferencia Sobre economia nacional",
  ...
  {
    title: "Conferencia de la iglesia ",
    price: "Obten mas información",
    image:
  ...
  {
    title: "Conferencia sobre politica y comercio internacional ",
    price: "Obten mas información",
    image:
